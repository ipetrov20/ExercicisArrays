...
function testPaintCheckerboard() {
    if (typeof paintCheckerboard == "function") {
	    try {
		    ...
		    }else if (!([...document.getElementsByTagName("tr")].filter((e,i)=>i%2==1).map((e)=>[...e.children]).flat().filter((e,i)=>(i%2)==1).every((e)=>e.style.backgroundColor == "red") && [...document.getElementsByTagName("tr")].filter((e,i)=>i%2==0).map((e)=>[...e.children]).flat().filter((e,i)=>(i%2)==0).every((e)=>e.style.backgroundColor == "red"))) {
			    console.log("❌paintCheckerboard2 incorrecte");
		    } else {
...
function testPaintCheckerboard2() {
    if (typeof paintCheckerboard2 == "function") {
	    try {
		    ...
		    }else if (!([...document.getElementsByTagName("tr")].filter((e,i)=>i%2==1).map((e)=>[...e.children]).flat().filter((e,i)=>(i%2)==0).every((e)=>e.style.backgroundColor == "red") && [...document.getElementsByTagName("tr")].filter((e,i)=>i%2==0).map((e)=>[...e.children]).flat().filter((e,i)=>(i%2)==1).every((e)=>e.style.backgroundColor == "red"))) {
			    console.log("❌paintCheckerboard2 incorrecte");
		    } else {
			    console.log("✅ paintCheckerboard2 test passat");
		    }
